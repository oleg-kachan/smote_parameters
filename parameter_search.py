...
if __name__ == "__main__":
    ...
    group1.add_argument("-i", "--input", help='Input, .npy file of landmarks', nargs='*', required=True)
    ...
    group2.add_argument("-m", "--method", choices=["simplicial", "simplicial_maximal"], help="Oversampling method, default='simplicial_maximal'", default="simplicial_maximal")
